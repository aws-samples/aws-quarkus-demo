...
class EcsCdkStack extends cdk.Stack {
    constructor(scope, id, props) {
        ...
        const container = taskDef.addContainer('quarkus-demo-web', {
            image: ecs.ContainerImage.fromRegistry("smoell/quarkus_ecs_demo:0.5"),
            memoryLimitMiB: 256,
            cpu: 256,
            logging
        });
